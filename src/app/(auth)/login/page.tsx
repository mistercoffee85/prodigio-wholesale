  ...
  return (
    <>
      ...
      <div className="login-wrapper">
        ...
        <div className="auth-mobile-intro" style={{ display: 'none', background: 'linear-gradient(150deg, var(--forest) 0%, #2d1060 70%, #180535 100%)', color: 'white', padding: '26px 24px 24px' }}>
        ...
        <div className="login-brand">
          ...
          <div style={{ position: 'absolute', top: '10%', right: '-15%', width: 380, height: 380, background: 'radial-gradient(circle, rgba(94,30,184,.35) 0%, transparent 70%)', pointerEvents: 'none' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                <div key={text} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <span style={{ width: 34, height: 34, borderRadius: 10, background: 'rgba(94,30,184,.3)', border: '1px solid rgba(94,30,184,.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, flexShrink: 0 }}>{icon}</span>
        ...
        <div className="login-form">
          <div style={{ width: '100%', maxWidth: 400 }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '14px', fontSize: 15, marginTop: 4, borderRadius: 'var(--radius-lg)' }} disabled={loading}>
