        ...
        <div className="register-form-panel">
          <div className="register-form-inner">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              <h2 style={{ fontSize: 'clamp(20px, 4vw, 26px)', fontWeight: 700, color: 'var(--black)' }}>
            ...
            {step === 1 ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 8, flexWrap: 'wrap' }}>
                  ...
                  <button type="submit" className="btn btn-primary" style={{ flex: 1, minWidth: 180, padding: '14px', fontSize: 15, borderRadius: 'var(--radius-lg)' }} disabled={loading}>
