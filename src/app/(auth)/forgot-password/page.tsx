    ...
    <>
      ...
      <div className="fp-outer">
        ...
        <div className="fp-brand">
          ...
          <div style={{ position: 'absolute', top: '10%', right: '-15%', width: 'clamp(200px,30vw,380px)', height: 'clamp(200px,30vw,380px)', background: 'radial-gradient(circle, rgba(94,30,184,.25) 0%, transparent 70%)', pointerEvents: 'none' }} />
